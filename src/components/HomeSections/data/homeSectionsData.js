...
export const reasons = [
  {
    image: homeImages.content.reasons.first,
  ...
  {
    image: homeImages.content.reasons.second,
  ...
  {
    image: homeImages.content.reasons.third,
  ...
  {
    image: homeImages.content.reasons.fourth,
...
export const stories = [
  {
    author: "David Lee",
    image: homeImages.content.stories.first,
  ...
  },
  {
    ...
    image: homeImages.content.stories.second,
  ...
  {
    author: "Sarah Ahmed",
    image: homeImages.content.stories.third,
...
export const homeBanners = [
  {
    id: "franchise-intro",
    background: "#891b1c",
    backgroundImage: sharedBannerImages.intro.background,
    ...
    features: [
      {
        icon: sharedBannerImages.intro.features.globalRecognition,
        text: "Global brand recognition with loyal customers in 36+ countries.",
        title: "Global Recognition",
      },
      {
        icon: sharedBannerImages.intro.features.comprehensiveSupport,
        text: "Full support across operations, marketing, and logistics.",
        title: "Comprehensive Support",
      },
      {
        icon: sharedBannerImages.intro.features.halalCertified,
    ...
    title: {
      desktopLines: [
        [
          { text: "Take The " },
          { strong: "First Step" },
          { text: " Toward Owning A" },
        ],
        [
          { text: "Successful Global " },
